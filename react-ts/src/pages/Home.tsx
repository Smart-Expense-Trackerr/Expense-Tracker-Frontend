  ...
  return (
    ...
    <div className="absolute inset-0 min-h-screen bg-[url('/background.jpg')] bg-cover bg-center">
        <div className="absolute inset-0 bg-black/70 "/>
         <div className="relative z-10 md:py-5 py-10 min-h-screen">
        <div className="w-full px-4 sm:px-6 md:px-0 md:max-w-3xl md:mx-auto text-center">
            <h1 className="font-bold md:text-4xl text-3xl text-text-primary"> Welcome to FinSight</h1>
            <p className="mt-4 font-medium text-text-primary">Track smarter. <strong>Spend wiser.</strong> </p>

            <div className="flex flex-col md:mt-7 mt-8 md:space-y-3 space-y-5">
                <motion.div 
                whileHover={{
                    y: -10,
                    scale: 1.05,
                ...
                className="border w-full max-w-md font-medium mx-auto flex md:gap-5 gap-10 rounded-2xl shadow-2xl text-text-primary p-3 md:py-3 py-4.5">
                ...
                className="border w-full max-w-md flex font-medium mx-auto md:gap-5 gap-3 rounded-2xl shadow-2xl text-text-primary p-3 py-2 md:py-3">
                ...
                className="border w-full max-w-md flex font-medium mx-auto md:gap-5 gap-3 rounded-2xl shadow-2xl text-text-primary pl-3 py-2 md:py-3">
                ...
                <motion.div 
                    ...
                    className="border w-full max-w-md flex font-medium mx-auto md:gap-5 gap-3 rounded-2xl shadow-2xl text-text-primary p-3 py-2 md:py-3">
                    <PiggyBank className="text-pink-400" size={28} />
                        Your personal finance insight dashboard.
                    </motion.div>
                    <motion.div 
                    whileHover={{
                    ...
                    className="border w-full max-w-md flex font-medium mx-auto md:gap-5 gap-11 rounded-2xl shadow-2xl text-text-primary p-3 md:py-3 py-4.5">
