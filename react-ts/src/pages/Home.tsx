    ...
    <div className="absolute inset-0 min-h-screen bg-[url('/background.jpg')] bg-cover bg-center">
        ...
        <div className="w-full px-4 sm:px-6 md:px-0 md:max-w-3xl md:mx-auto text-center">
            ...
            <div className="flex flex-col mt-10 space-y-5 ">
                ...
                className="border w-full max-w-md font-medium mx-auto flex gap-5 rounded-2xl shadow-2xl text-text-primary p-5">
                ...
                className="border w-full max-w-md flex font-medium mx-auto gap-5 rounded-2xl shadow-2xl text-text-primary p-5">
